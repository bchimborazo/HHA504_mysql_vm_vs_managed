# managed_demo.py — Linear, step-by-step demo for managed MySQL - GCP
...
# --- 1) Connect to server WITHOUT specifying database, then create database ---
...
print(f"[STEP 3] Writing DataFrame to table: {table_name}")
